<html>
 ...
 <body>
  ...
  <div class="form-group">
    <label for="code_demande">code Demande</label>
    <input  name="code_demande" id="code_demande"class="form-control" placeholder="Code Demande">
  </div>

  <div class="form-group">
    <label for="code_frs">Code Mecanicien</label>
    <select class="form-control" 
    name="code_frs"
    id="code_frs"
    >
    @foreach($mecanicien as $forn)
      <option value="{{$forn->matricule}}">{{$forn->matricule}}</option>
...
$(document).ready(function(){
 ...
 function dynamic_field(number)
 {
  ...
  html = '<tr  class="row">';
        html += '<td><select id="code_pie[]" name="code_pie[]" class="form-control" >@foreach($pieces_rechange as $forn)<option value="{{$forn->code_pie}}">{{$forn->code_pie}}</option>@endforeach</select></td>';
        html += '<td><input name="model_pie[]" class="form-control" type="number"></td>';
...
// function recalculant le prix d'un ligne et retournant le prix
 ...
 $('#dynamic_form').on('submit', function(event){
        ...
        var code_facture = $('#code_demande').val();
    
        var code_frs = $('#code_frs').find(":selected").val()
        $.ajax({
          url:`/facture_demande_traveaux/${code_facture}/${code_frs}`,
            method:'post',
            data:$(this).serialize(),
            dataType:'json',
            beforeSend:function(){
