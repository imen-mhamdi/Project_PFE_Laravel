<x-app-layout>
 ...
 <div>
        ...
        <div class="block mb-8">
                <a  href="/create_produit_vidange"  class="   hover:text-indigo-900 mb-2 mr-2 ">
                                ...
                                @foreach ($produits as $user)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="/editProduitVidange/{{$user->id}}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2">Modifier</a>
                                        </td>
