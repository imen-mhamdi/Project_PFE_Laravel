<x-app-layout>
 ...
 <div>
        ...
        <div class="block mb-8">
                <a  href="/piece_rechange_interface_globale"  class="   hover:text-indigo-900 mb-2 mr-2 ">
                   
                    <button class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                    Piece Rechange
                            </button>
                </a>
                <a  href="/fournisseur"  class="  hover:text-indigo-900 mb-2 mr-2 ">
               ...
               <a  href="/facturation"  class="  hover:text-indigo-900 mb-2 mr-2 ">
            ...
            <div class="flex flex-col">
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                ...
                                @foreach ($facturations as $user)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="/getFactureInformation/{{$user->code_facture}}/{{$user->date_facture}}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2">
                                            <button 
                    ...
                    Afficher
                                            ...
                                            <a href="/print_facture/{{$user->code_facture}}/{{$user->date_facture}}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2">
                                            <button 
