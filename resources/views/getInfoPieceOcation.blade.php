<x-app-layout>
 ...
 <div>
        ...
        <div class="block mb-8">
                <a  href="/imprimer_piece_occassion/{{$N_br}}/{{$specificdate->DATE_BR}}"  class="   hover:text-indigo-900 mb-2 mr-2 ">
        ...
        <h1>Date de  creation piece occation :{{$specificdate->DATE_BR}} </h1>
        <div class="px-3 py-5 bg-grey sm:p-4">
