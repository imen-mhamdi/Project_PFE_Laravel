<html>
 ...
 <body>
  <div class="container">    
    ...
    <label for="exampleFormControlInput1">Date Bon de retour</label>
  ...
  <div class="form-group">
    <label for="N°_BR">N  Bon de retour </label>
    <input  name="N°_BR" id="N°_BR"class="form-control" placeholder="N Bon de retour">
  </div>
   ...
   <div class="table-responsive">
               ...
               <thead>
                <tr>
                <th width="0.5%"></th>
                    <th width="50%">Code Piece</th>
                    <th width="50%">Qte Piece</th>
...
// function recalculant le prix d'un ligne et retournant le prix
 ...
 $('#dynamic_form').on('submit', function(event){
        ...
        $.ajax({
          url:`/pieceOccassion_facture/${N_br}`,
            method:'post',
            data:$(this).serialize(),
            dataType:'json',
            beforeSend:function(){
