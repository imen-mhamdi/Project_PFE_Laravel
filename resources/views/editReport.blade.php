   ...
   <x-slot name="header">
    ...
    <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-1">
                <form method="post" action="/update_report/{{$single_report->id}}">
                @csrf
                @method('put')
                    <div class="flex ">
                        <div class="px-4 py-5 bg-white sm:p-4">
                            ...
                            value="{{ old('code_rap', $single_report->code_rap) }}"
                            disabled
                        ...
                        <div class="px-4 py-5 bg-white sm:p-4">
                            ...
                            value="{{ old('etat_carros', $single_report->etat_carros) }}"
       ...
       value="{{ old('km_vehicule_rapport', $single_report->km_vehicule_rapport) }}"
...
>
                            ...
                            <select name="code_veh" 
                            value="{{ old('code_veh', $single_report->code_veh) }}"
                            id="code_veh" class="form-multiselect block rounded-md shadow-sm mt-1 block w-full">
                            @foreach ($vehicules as $user)
                                    <option value="{{$user->code_veh}}">
                                    {{ ($single_report->code_veh==$user->code_veh)? "selected" : "" }}    
                                    
                                    {{$user->code_veh}}</option>
                                    @endforeach
       ...
       class="form-input rounded-md shadow-sm mt-1 block w-full"
       value="{{ old('pneaumatique', $single_report->pneaumatique) }}"
       />
                            @error('pneaumatique')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
...
<div class="px-3 py-5 bg-white sm:p-4">
                       ...
                       placeholder="{{ old('remarques', $single_report->remarques) }}"
                          value=" old('remarques', $single_report->remarques) }}"
